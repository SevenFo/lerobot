...
def main():
    ...
    output_directory = Path("outputs/train/example_pressed_grasp_spanner_diffusion")
    ...
    output_repo_id = "pressed_grasp_spanner"
    ...
    dataset_metadata = LeRobotDatasetMetadata(output_repo_id, dataset_root)
